...
class BaseConfig(BaseSettings):
    ...
    # AWS_ACCESS_KEY_ID:str = os.getenv("AWS_ACCESS_KEY_ID","Not Found")
    # AWS_SECRET_ACCESS_KEY:str = os.getenv("AWS_SECRET_ACCESS_KEY","Not Found")
    # AWS_REGION:str = os.getenv("AWS_REGION","Not Found")
    # AWS_BUCKET:str = os.getenv("AWS_BUCKET","Not Found")
